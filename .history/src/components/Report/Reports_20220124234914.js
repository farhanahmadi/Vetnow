            ...
            <section className={styles.main}>
               ...
               <br />
                ...
                <section className={styles.inputs} dir='rtl'>
                    ...
                    <input type="number" value={data.startDate} placeholder="تعداد محصول" name="quantity" onChange={inputsHandler} />
                    <input type="number" value={data.endDate} placeholder="قیمت فروش" name="salesPrice" onChange={inputsHandler} />
                </section>
            </section>
