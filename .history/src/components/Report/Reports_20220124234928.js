            ...
            <section className={styles.main}>
               ...
               <br />
                ...
                <section className={styles.inputs} dir='rtl'>
                    ...
                    <input type="number" value={data.startDate} placeholder="تاریخ شروع" name="quantity" onChange={inputsHandler} />
                    <input type="number" value={data.endDate} placeholder="تاریخ پایان" name="salesPrice" onChange={inputsHandler} />
                </section>
            </section>
