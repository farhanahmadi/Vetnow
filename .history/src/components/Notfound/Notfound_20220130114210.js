...
<div className={styles.container}>
	...
	<div className={styles.right_section}>
        ...
        <g id="lamp">
          ...
          <circle className={styles.lamp_light__glow} fill="url(#SVGID_1_)" cx="119.676" cy="44.22" r="65"/>
          <path className={styles.lamp_bottom} d="M135.417,487.781c0,1.378-1.244,2.496-2.778,2.496H106.25c-1.534,0-2.778-1.118-2.778-2.496v-74.869
