...
const EditCategory = (props) => {
    ...
    useEffect( async () =>{
        await axios.get(`https://f41f5c809bb0ed.lhr.life/api/v1/category/update/${props.match.params.slug}`).then(res => setData({
    ...
    const submitHandler = (event) =>{
        ...
        axios.put(`${}/api/v1/category/update/${props.match.params.slug}/` , {
            parent: data.parent,
