...
export default function EditOrder(props) {
    ...
    const inputHandler = (event) =>{
        setData({...data , confirmation: event.target.value})
    }
    ...
    return (
        ...
        <form className={styles.main} onSubmit={submitHandler}>
            ...
            <section className={styles.inputs} dir='rtl'>
                ...
                <section className={styles.labelSection}>
                    <label className={styles.checkBox}><input type="checkbox" disabled checked={data.confirmation} value={data.confirmation} onChange={inputHandler} />تایید شده ؟</label>
                </section>
