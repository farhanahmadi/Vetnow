...
const AddUser = () => {
    ...
    const submitHandler = async (event) =>{
        ...
        data.secoundImg  && photo1 && formD.append('Incubation_license' , photo , photo.name)
        data.thirdImg  && photo2 && formD.append('other' , photo , photo.name)
     ...
     photo && formD.append('avatar' , avatar , avatar.name)
