...
const EditView = (props) => {
  ...
  useEffect(async () => {
    const getImg = await axios
      ...
      .then((res) =>
        setData({
          ...data,
          photo1:res.data.image1 ? res.data.image1 : '',
          photo2: res.data.image2 ? res.data.image2 : '' ,
  ...
  const submitHandler = async (event) => {
    ...
    data.photo1       ? formD.append("image1", photo.photo1, photo.photo1.name)
      : formD.append("image1", "");
    data.photo2
