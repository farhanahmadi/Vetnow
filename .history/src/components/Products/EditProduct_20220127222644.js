...
const EditProduct  = (props) => {
    ...
    //
     ...
     useEffect( async () =>  {
        const URL = `${Main}/api/v1/product/update/${props.match.params.slug}/`
    ...
    // 
      ...
      useEffect(async () =>  {
        ...
        const category = await axios.get("${Main}/api/v1/categoies/");
    ...
    const submitHandler = async (event) =>{
        ...
        fetch(`${Main}/api/v1/product/update/${props.match.params.slug}/`,{
            method:"PUT",
            body:formD
