...
const EditProduct  = (props) => {
    ...
    //
     ...
     useEffect( async () =>  {
        const URL = `https://9c25944eba9ca2.lhr.life/api/v1/product/update/${props.match.params.slug}/`
        ...
        setData(await {...data , 
            ...
            pdf_file: inputValue.data.pdf_file,
    ...
    // 
      ...
      useEffect(async () =>  {
        ...
        const category = await axios.get("https://9c25944eba9ca2.lhr.life/api/v1/categoies/");
    ...
    const submitHandler = async (event) =>{
        ...
        formD.append('pdf_file' , pdf , pdf.name)
        fetch(`https://9c25944eba9ca2.lhr.life/api/v1/product/update/${props.match.params.slug}/`,{
            method:"PUT",
            body:formD
