...
const EditProduct  = (props) => {
    ...
    //
     ...
     useEffect( async () =>  {
        const URL = `${}/api/v1/product/update/${props.match.params.slug}/`
    ...
    // 
      ...
      useEffect(async () =>  {
        ...
        const category = await axios.get("${}/api/v1/categoies/");
    ...
    const submitHandler = async (event) =>{
        ...
        fetch(`${}/api/v1/product/update/${props.match.params.slug}/`,{
            method:"PUT",
            body:formD
