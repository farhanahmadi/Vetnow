    ...
    return (
        ...
        <form className={styles.main} onSubmit={submitHandler}>
            ...
            <section className={styles.inputs} dir='rtl'>
                ...
                <input type="text" value={data.subcategoryName} placeholder="درصد تخفیف را وارد کنید" name="discountPercent" onChange={inputHandler} />
                <input type="text" value={data.subcategoryName} placeholder="تاریخ شروع تاریخ" name="valid_from" onChange={inputHandler} />
                <input type="text" value={data.subcategoryName} placeholder="تاریخ پایان تخفیف" name="valid_to" onChange={inputHandler} />
            </section>
            <br />
