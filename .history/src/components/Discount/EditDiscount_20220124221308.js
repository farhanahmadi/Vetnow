...
export default function EditDiscount(props) {
    ...
    useEffect( async () =>{
        ...
        await axios.get(`${MainLink}/api/v1/discount_update/list/${props.match.params.id}`).then(res => setData({...data , 
    ...
    return (
        ...
        <form className={styles.main} onSubmit={submitHandler}>
            ...
            <section className={styles.inputs} dir='rtl'>
                ...
                <input type="text" value={shamsi.gregorianToJalali(1989, 1, 24).join('/')} placeholder="تاریخ شروع تخفیف" name="valid_from" onChange={inputHandler} />
