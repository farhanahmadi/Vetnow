...
export default function EditDiscount(props) {
    ...
    const DeleteProductHandler = (e) =>{
        const newListProducts = data.productId.filter(item => item != e.target.value)
        const newListProd = data.productId.filter(item => item != e.target.value)
        setData({...data , productId: newList})
        console.log(newList);
