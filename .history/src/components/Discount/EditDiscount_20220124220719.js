    ...
    return (
        ...
        <form className={styles.main} onSubmit={submitHandler}>
            ...
            <section className={styles.inputs} dir='rtl'>
                ...
                <input type="text" value={data.subcategoryName} placeholder="درصد تخفیف" name="subcategoryName" onChange={inputHandler} />
                <input type="text" value={data.subcategoryName} placeholder="تاریخ شروع تخفیف" name="subcategoryName" onChange={inputHandler} />
