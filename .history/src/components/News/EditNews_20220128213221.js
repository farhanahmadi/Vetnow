...
const EditNews = () => {
    ...
    //
     ...
     useEffect( async () =>  {
        ...
        setData(await {...data , 
            title: inputValue.data.name,
            username: inputValue.data.author.slug,
            title_image: inputValue.data.categories[0],
            body: inputValue.data.categories[1],
            created_at: inputValue.data.quantity,
        })
