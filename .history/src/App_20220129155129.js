...
function App() {
  ...
  useEffect(async () =>  {
    axios.get(`${MainLink}/api/v1/check/user/per/`,{
      ...
      }).then(response => setIsAdmin(response.data.login))
  ...
  return (
    <div className="App">
        ...
        {currentLocation !=  '/' && currentLocation != '/Login-Confirmation' && currentLocation != '/Notfound' && !isAdmin ?
        ...
        <Switch>
          <Route path="/Notfound" component={LoginConfirmation} />
