...
function App() {
  ...
  useEffect(async () =>  {
    const admin =  axios.get(`${MainLink}/api/v1/check/user/per/`,{
        headers:{
          'Authorization': 'Token '+ localStorage.getItem('token'), 
      },
      })
      setIsAdmin(await (await admin).data.is_admin)
     setIsload(true)
  ...
  return (
    <div className="App">
        ...
        :
        <div>
          {currentLocation != '/' && currentLocation != '/Login-Confirmation' && currentLocation != '/Notfound' && isload &&
