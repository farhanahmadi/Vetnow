...
const EditParentCategory = () => {
    ...
    useEffect( async () =>{
        await axios.get(`https://4fe38b5f966158.lhr.life/api/v1/categories/`).then(res => setCategory(res.data))
    ...
    const submitHandler = (event) =>{
        ...
        axios.put(`https://4fe38b5f966158.lhr.life/api/v1/category/update/${data.slug}/` , {
            name: data.parentCategory,
        }).then(res => console.log(res))
    }
    const categoryDeleteHandler =(slug) =>{
        console.log(slug);
        axios.delete(`https://4fe38b5f966158.lhr.life/api/v1/category/delete/${slug}/`)
    }
    return (
