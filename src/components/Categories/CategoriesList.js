...
const CategoriesList = () => {
    ...
    let URL = `https://e0514de8edc6d6.lhr.life/api/v1/pagination/categories/?page=${paginate}`;
...
const deleteHandler = (slug) =>{
    axios.delete(`https://e0514de8edc6d6.lhr.life/api/v1/category/delete/${slug}/`)
}
    return (
